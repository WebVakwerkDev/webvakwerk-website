...
const CTA = () => {
  return (
    <section id="contact" className="scroll-mt-28 mx-6 mb-6 rounded-[2rem] py-24 px-6 bg-gradient-to-br from-primary to-primary/90 shadow-[0_24px_80px_-20px_hsl(var(--warm-orange)/0.35)]">
      <motion.div
